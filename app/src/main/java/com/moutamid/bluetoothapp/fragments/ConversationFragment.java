package com.moutamid.bluetoothapp.fragments;
...
import com.moutamid.bluetoothapp.gui.CustomAnimator;
import com.moutamid.bluetoothapp.gui.GuiTools;
import com.moutamid.bluetoothapp.gui.MessagesAdapter;
            ...
            public void onClick(View v) {
                if (global.getBluetoothCommunicator().getConnectedPeersList().size() > 0) {
                    ...
                    if (editText.getText().length() > 0) {
                        ...
                        /*String name = global.getBluetoothCommunicator().getConnectedPeersList().get(0).getUniqueName();
                        String name2 = global.getBluetoothCommunicator().getUniqueName();
                        editText.setText(name + "---" + name2);*/
                    }
                }
            }
        });
